...
WebUI.click(findTestObject('Button/CC_Back'))

WebUI.click(findTestObject('Button/CC_Yes, cancel'))

WebUI.verifyElementPresent(findTestObject('PaymentMethod/SelectMethods'), 0)
