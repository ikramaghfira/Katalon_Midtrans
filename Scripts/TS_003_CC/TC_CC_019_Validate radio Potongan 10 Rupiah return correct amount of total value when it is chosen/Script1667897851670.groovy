...
WebUI.scrollToElement(findTestObject('FeaturesOnCC/Radio_Potongan10Rp'), 0)

WebUI.click(findTestObject('FeaturesOnCC/Radio_Potongan10Rp'))

WebUI.verifyElementText(findTestObject('FeaturesOnCC/Header_Total'), 'Rp19.990')
